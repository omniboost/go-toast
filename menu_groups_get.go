...
func (r *MenuGroupsGetRequest) Do(ctx context.Context) (MenuGroupsGetResponseBody, error, *http.Response) {
	// Create http request
...
func (r *MenuGroupsGetRequest) All(ctx context.Context) (MenuGroupsGetResponseBody, error) {
