...
func (r *TaxRatesGetRequest) Do(ctx context.Context) (TaxRatesGetResponseBody, error, *http.Response) {
	// Create http request
...
func (r *TaxRatesGetRequest) All(ctx context.Context) (TaxRatesGetResponseBody, error) {
