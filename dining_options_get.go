...
func (r *DiningOptionsGetRequest) Do(ctx context.Context) (DiningOptionsGetResponseBody, error, *http.Response) {
	// Create http request
...
func (r *DiningOptionsGetRequest) All(ctx context.Context) (DiningOptionsGetResponseBody, error) {
