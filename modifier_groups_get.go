...
func (r *ModifierGroupsGetRequest) Do(ctx context.Context) (ModifierGroupsGetResponseBody, error, *http.Response) {
	// Create http request
...
func (r *ModifierGroupsGetRequest) All(ctx context.Context) (ModifierGroupsGetResponseBody, error) {
