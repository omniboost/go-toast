...
func (r *MenuItemsGetRequest) Do(ctx context.Context) (MenuItemsGetResponseBody, error, *http.Response) {
	// Create http request
...
func (r *MenuItemsGetRequest) All(ctx context.Context) (MenuItemsGetResponseBody, error) {
